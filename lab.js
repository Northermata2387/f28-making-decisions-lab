...
//   console.log(`Brittani is older at age ${brittanisAge}`)
// } else if ( amysAge > brittanisAge ){
//   console.log(`Amy is older at age ${amysAge}`)
// } else {
//   amysAge === brittanisAge 
//   console.log(`They are the same age at age ${amysAge}`)
// }
